...
CVES_JSON_PATH = join(pathlib.Path(__file__).parent.absolute(), "output/alertsync.json")
...
KEYWORDS_CONFIG_PATH = join(pathlib.Path(__file__).parent.absolute(), "config/alertsync.yaml")
ALL_VALID = False
